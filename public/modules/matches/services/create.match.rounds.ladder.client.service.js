...
angular.module('match_rounds').factory('CreateMatchRoundsLadder', ['$filter', 'CoreHelper','MatchHelper','TournamentResults','CreateMatchRoundsCore','_service', function($filter,CHelper, MHelper, TResults,CMRoundsC,_s) {
